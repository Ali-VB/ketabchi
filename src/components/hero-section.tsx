                ...
                <div className="flex flex-col items-center space-y-4 text-center">
                    <div className="mx-auto max-w-2xl space-y-8">
                        <div className="space-y-4">
                            <h1 className="text-2xl sm:text-3xl md:text-4xl font-display bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent leading-relaxed tracking-normal">
